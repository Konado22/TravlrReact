        ...
        <div>
            <div className="flex flex-row gap-x-6 bg-orange-200 justify-between ">
                ...
                <div className="flex flex-row space-x-10 pr-5">
                    <div className="flex items-end"><Link href=''><h1 className="text-xl text-slate-500 hover:border-2 border-black rounded-md hover:bg-orange-300 hover:text-2xl">Travel</h1></Link></div>
                    <div className="flex items-end"><Link href=''><h1 className="text-xl text-slate-500 hover:border-2 border-black rounded-md hover:bg-orange-300 hover:text-2xl">Entertainment</h1></Link></div>
